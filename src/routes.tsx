...
import CompressionPage, { meta as compressionMeta } from '@/pages/Compression';
import ConformancePage, { meta as conformanceMeta } from '@/pages/Conformance';
...
export const routeDefs: RouteDef[] = [
  ...
  { path: routes.compression, meta: compressionMeta, Component: CompressionPage },
  { path: routes.conformance, meta: conformanceMeta, Component: ConformancePage },
